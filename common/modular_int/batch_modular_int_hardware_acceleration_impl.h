...
#ifndef COMMON_MODULAR_INT_BATCH_MODULAR_INT_HARDWARE_ACCELERATION_IMPL_H_
#define COMMON_MODULAR_INT_BATCH_MODULAR_INT_HARDWARE_ACCELERATION_IMPL_H_
...
int MaximumBatchAddInPlaceWithHardware(std::vector<ModularInt<T>>* in1,
  ...
  i = MaximumBatchAddInPlaceWithAvx2(in1, in2, params);
#endif
  return i;
}
...
int MaximumBatchSubInPlaceWithHardware(std::vector<ModularInt<T>>* in1,
  ...
  int i = 0;
#if MODULAR_INT_AVX2_ENABLED
  i = MaximumBatchSubInPlaceWithAvx2(in1, in2, params);
#endif
  return i;
}
...
int MaximumBatchMulInPlaceWithHardware(std::vector<ModularInt<T>>* in1,
  ...
  int i = 0;
#if MODULAR_INT_AVX2_ENABLED
  i = MaximumBatchMulInPlaceWithAvx2(in1, in2, params);
#endif
  return i;
}
...
int MaximumBatchFusedMulAddInPlaceWithHardware(
  ...
  int i = 0;
#if MODULAR_INT_AVX2_ENABLED
  i = MaximumBatchFusedMulAddInPlaceWithAvx2(in1, in2, in3, params);
#endif
  return i;
}
...
#endif  // COMMON_MODULAR_INT_BATCH_MODULAR_INT_HARDWARE_ACCELERATION_IMPL_H_
